...
Inserisci 5 per aggiungere un admin: \n
  """
...
def aggiungi_utenti():
    ...
    utente=nome_utente+","+psw
    with open("utente.bin", "wb") as file:
        file.write(utente)


def aggiungi_admin():
    nome_admin=input("inserisci il nome dell'admin che vuoi aggiungere")
    psw=input("inserisci la password")
    admin=nome_admin+","+psw
    with open("admin.bin","wb") as file:
        file.write(admin)
