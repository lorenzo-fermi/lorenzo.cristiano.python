...
# Creazione di un'istanza della classe figlia Cane
...
# Creazione di un'istanza della classe figlia Gatto
...
# Creazione di un'istanza della classe figlia Coccodrillo
